...
* Написать рекурсивный метод, проверяющий равенство сумм цифр одного числа и второго числа
* Написать рекурсивный метод, рассчитывающий количество делителей числа.